...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    // Module-loader convention (dsh-client-modules): the factory builds its own
    // CJS export object — without these declarations the browser throws
    // "exports is not defined" while importing this bundle.
    var module = { exports: {} };
