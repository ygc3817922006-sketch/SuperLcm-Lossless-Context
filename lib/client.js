...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const en = {
      ...
      intro: "Summarizer model and context compaction parameters",
      expand: "Expand",
      collapse: "Collapse",
    ...
    /** Snapshot-store hook over a settings scope (or an unavailable stand-in). */
    ...
    /** Load the Host model catalog once per card open; `reload` retries. */
    ...
    function LosslessContextPluginCard({ t, configScope, loadCatalog }) {
      ...
      return e("li", { style: { ...cardStyle, background: "var(--dsw-alias-bg-layer-" + (open ? "2" : "3") + ")" } },
        e("button", {
          ...
          chevron(open)),
        open ? e("div", { style: cardBodyStyle }, e(SettingsForm, { t, configScope, loadCatalog })) : null);
    }
