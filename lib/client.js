...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    // examples/enable-compaction.patch.yml 的约定条目 id 是 SuperLcm-engine。
    const ENGINE_ENTRY_ID = "SuperLcm-engine";
    ...
    function apply(ctx) {
      ...
      // get(entryId) —— 按宿主 profile 里引擎条目的 id 寻址（约定 SuperLcm-engine）。
      const configScope = ctx.configForms.get(ENGINE_ENTRY_ID);
